            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  autoComplete="new-password"
                  className={`appearance-none block w-full px-4 py-3 border ${
                    errors.confirmPassword ? 'border-red-500' : 'border-purple-900/20'
                  } placeholder-gray-500 text-gray-300 bg-[#1A1723] rounded-md focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm pr-12`}
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#13111C] text-gray-400">Or sign up with</span>
            </div>
          </div>
          ...
          <div className="mt-6 flex justify-center">
            <GoogleLogin
              ...
              onError={(error) => setError('Google signup failed')}
              useOneTap
