...
const useCountAnimation = (targetValue, duration = 1000, delay = 0, startOnMount = true) => {
...
function Dashboard() {
    ...
    const animatedWorkouts = useCountAnimation(userStats.workoutsCompleted, 1000, 0);        // Starts immediately
    ...
    const handleChatSubmit = async (e) => {
        ...
        setTimeout(() => {
            const aiResponse = {
                type: 'ai',
                content: "I'm analyzing your question about fitness and nutrition. Here's my recommendation...",
                timestamp: new Date()
            };
            ...
            try {
                ...
                try {
                    ...
                    if (data.user) {
                        ...
                        const completionResponse = await fetch('http://localhost:4000/api/profile/checkProfileCompletion', {
                            method: 'GET',
                            headers: {
                                'Authorization': `Bearer ${token}`,
                                'Content-Type': 'application/json'
    ...
    useEffect(() => {
        const fetchWeeklyWorkouts = async () => {
            try {
                const startDate = getWeekDates(currentWeek)[0].toISOString().split('T')[0];
                const endDate = getWeekDates(currentWeek)[6].toISOString().split('T')[0];
                
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/api/workouts/weekly?start=${startDate}&end=${endDate}`,
                    {
                        headers: {
    ...
    useEffect(() => {
        const fetchLastWorkout = async () => {
            try {
                ...
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/user/last-workout`, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                    },
    ...
    const animatedLastWorkoutSeconds = useCountAnimation(lastWorkoutSeconds, 1000, 1000); // Starts after 1000ms
                ...
                <h1 className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-8">
                                    ...
                                    <div className="flex items-start gap-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="mt-2 text-gray-300 leading-relaxed">
                                                Take a moment to complete your profile information. This helps us provide you with a more personalized experience and tailored workout recommendations.
                                            </p>
                            ...
                            <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <h3 className="text-2xl font-bold text-white">{animatedWorkouts}</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <h3 className="text-2xl font-bold text-white">{animatedStreak} days</h3>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="ml-4">
                                        ...
                                        {lastWorkout.lastWorkoutDate && (
                                            <p className="text-sm text-gray-400">
                                                {new Date(lastWorkout.lastWorkoutDate).toLocaleDateString()}
                                            </p>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <h3 className="text-2xl font-bold text-white">{animatedPoints}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-8 bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-xl font-bold text-white">Weekly Overview</h2>
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-gray-400">
                                        {formatDate(getWeekDates(currentWeek)[0])} - {formatDate(getWeekDates(currentWeek)[6])}
                                    </span>
                                    <button 
                                        onClick={() => {
                            ...
                            <div className="grid grid-cols-7 gap-2">
                                {getWeekDates(currentWeek).map((date, index) => {
                                    ...
                                    const hasWorkout = weeklyWorkouts[dayKey];
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <Link href="/dashboard/workouts" className="group">
                                        <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6 
                                            ...
                                            <div className="w-12 h-12 bg-gradient-to-br from-purple-500/10 to-violet-500/10 
                                            ...
                                            <p className="text-gray-400">Begin your fitness journey with a new workout session.</p>
                                        </div>
                                    </Link>
                                    ...
                                    <Link href="/dashboard/nutrition" className="group">
                                        <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6 
                                                    hover:border-purple-500/40 transition-all duration-300 h-full">
                                            <div className="w-12 h-12 bg-gradient-to-br from-green-500/10 to-emerald-500/10 
                                            ...
                                            <p className="text-gray-400">Plan and track your daily nutrition intake.</p>
                                        </div>
                                    </Link>
                                </div>
                                ...
                                <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                    <div className="flex justify-between items-center mb-6">
                                        <h2 className="text-xl font-bold text-white">AI Training Assistant</h2>
                                        <span className="px-3 py-1 bg-gradient-to-r from-purple-500/10 to-violet-500/10 
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                                        <Link href="/dashboard/ai-coach" className="group">
                                            <div className="bg-purple-500/5 border border-purple-500/10 rounded-xl p-4 
                                                ...
                                                <div className="w-10 h-10 bg-gradient-to-br from-indigo-500/10 to-blue-500/10 
                                                ...
                                                <h3 className="text-white font-medium mb-1">AI Form Analysis</h3>
                                                <p className="text-sm text-gray-400">Get instant feedback on your exercise form and technique</p>
                                        ...
                                        <Link href="/dashboard/workout-generator" className="group">
                                            <div className="bg-purple-500/5 border border-purple-500/10 rounded-xl p-4 
                                                        hover:border-purple-500/30 transition-all duration-300 h-full flex flex-col">
                                                <div className="w-10 h-10 bg-gradient-to-br from-purple-500/10 to-violet-500/10 
                                                ...
                                                <h3 className="text-white font-medium mb-1">AI Workout Generator</h3>
                                                <p className="text-sm text-gray-400">Create personalized workout plans tailored to your goals and fitness level</p>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="group relative overflow-hidden rounded-xl">
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
                                                <h3 className="text-white font-semibold mb-1">Strength Training</h3>
                                                <p className="text-sm text-gray-300">8-week program</p>
                                            </div>
                                        </div>
                                        <div className="group relative overflow-hidden rounded-xl">
                                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent z-10"></div>
                                            ...
                                            />
                                            <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
                                                <h3 className="text-white font-semibold mb-1">HIIT Cardio</h3>
                                                <p className="text-sm text-gray-300">4-week program</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {['Beginner Yoga', 'Core Strength'].map((workout, index) => (
                                            <div key={workout} className="group cursor-pointer">
                                                <div className="relative h-32 rounded-lg overflow-hidden mb-3">
                                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent z-10"></div>
                                                    <img 
                                                        src={`https://source.unsplash.com/random/800x600?fitness,${index}`}
                                                        alt={workout}
                                                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                                                    />
                                                    <div className="absolute bottom-3 left-3 right-3 z-20">
                                                        <h3 className="text-white font-semibold">{workout}</h3>
                                                        <p className="text-sm text-gray-300">20 min • Beginner</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                    ...
                                    <div className="flex items-center mb-4">
                                        ...
                                        <span className="text-gray-300">{user?.subscription?.plan || 'Free'} Plan</span>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center p-3 bg-purple-500/5 border border-purple-500/10 rounded-lg">
                                            ...
                                            <div className="ml-3">
                                                ...
                                                <p className="text-sm text-gray-400">Welcome to your fitness journey!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                    ...
                                    <div className="space-y-3">
                                        {[1, 2, 3].map((position) => (
                                            <div key={position} className="flex items-center p-3 bg-purple-500/5 border border-purple-500/10 rounded-lg">
                                                ...
                                                <div className="ml-3 flex-1">
                                                    <h3 className="text-white font-medium">User {position}</h3>
                                                    <p className="text-sm text-gray-400">{1000 - position * 100} points</p>
                                                </div>
                                                {position === 1 && (
                                                    <div className="w-6 h-6 text-yellow-400">
                                                        <svg fill="currentColor" viewBox="0 0 20 20">
                                                            <path fillRule="evenodd" d="M10 2a1 1 0 01.894.553l2.991 5.657 6.789.907a1 1 0 01.553 1.706l-4.949 4.524 1.173 6.718a1 1 0 01-1.451 1.054L10 19.5l-5.999 2.618a1 1 0 01-1.451-1.054l1.173-6.718-4.949-4.524a1 1 0 01.553-1.706l6.789-.907L9.106 2.553A1 1 0 0110 2z" clipRule="evenodd" />
                                                        </svg>
                                                    </div>
                                                )}
                                            </div>
                                ...
                                <div className="bg-[#1E1B29]/95 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
                                    <div className="flex justify-between items-center mb-6">
                                        ...
                                        <span className="px-3 py-1 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-purple-500/5 border border-purple-500/10 rounded-lg p-4">
                                            <div className="flex items-start">
                                                <div className="w-8 h-8 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 
                                                ...
                                                <div className="ml-3">
                                                    <h3 className="text-white font-medium mb-1">Workout Analysis</h3>
                                                    <p className="text-sm text-gray-400">Based on your recent activities, try increasing your cardio intensity for better results.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-purple-500/5 border border-purple-500/10 rounded-lg p-4">
                                            <div className="flex items-start">
                                                <div className="w-8 h-8 bg-gradient-to-br from-green-500/10 to-emerald-500/10 
                                                ...
                                                <div className="ml-3">
                                                    <h3 className="text-white font-medium mb-1">Nutrition Suggestion</h3>
                                                    <p className="text-sm text-gray-400">Consider increasing your protein intake to support muscle recovery.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <button className="w-full mt-4 py-2 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 
