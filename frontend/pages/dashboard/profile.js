...
function Profile() {
    ...
    const handleAddProtein = () => {
        if (newProtein.trim()) {
            setFormData({ ...formData, proteinPreference: [...formData.proteinPreference, newProtein.trim()] });
            setNewProtein('');
        }
    };
    ...
    const handleRemoveProtein = (indexToRemove) => {
        setFormData({
            ...formData,
            proteinPreference: formData.proteinPreference.filter((_, index) => index !== indexToRemove)
        });
    };
    ...
    const handleSaveProfileInfo = async () => {
        ...
        setIsSaving(true);
        try {
            const response = await fetch('http://localhost:4000/api/profile/updatePersonalInfo', {
                method: 'PUT',
                headers: {
            ...
            const profileResponse = await fetch('http://localhost:4000/api/profile/getUserProfile', {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`,
                },
            });
                    ...
                    <div className="bg-[#1E1B29] p-8 rounded-xl shadow-xl border border-purple-900/20">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[...Array(4)].map((_, i) => (
                                    <div key={i} className="h-12 bg-purple-500/10 rounded-lg"></div>
                                ))}
                            </div>
                        </div>
                            ...
                            <div className="relative py-16">
                                <div className="max-w-7xl mx-auto px-4">
                                    <div className="flex flex-col md:flex-row items-center gap-8">
                                        ...
                                        {/* User Info */}
                                        <div className="md:ml-8">
                                            <h1 className="text-3xl font-bold text-white mb-2">{formData.fullName || 'Your Profile'}</h1>
                    ...
                    <div className="max-w-7xl mx-auto px-4 py-12">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <>
                                        <div className="grid gap-6">
                                            {[
                                                ...
                                                { label: 'Height (cm)', name: 'height', placeholder: 'Enter your height', type: 'number' },
                                                { label: 'Weight (kg)', name: 'weight', placeholder: 'Enter your weight', type: 'number' },
                                                { label: 'Contact Number', name: 'contactNumber', placeholder: 'Enter your contact number', type: 'tel' },
                                                { label: 'Location', name: 'location', placeholder: 'Enter your location', type: 'text' },
                                                { label: 'Experience', name: 'trainingExperience', placeholder: 'Enter your training experience', type: 'text' },
                            ...
                            <div className="bg-[#1E1B29] p-8 rounded-xl shadow-xl border border-purple-900/20 hover:border-purple-500/30 transition-all duration-300">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {formData.allergies.map((allergy, index) => (
                                            <div key={index} 
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-3 text-gray-300 text-sm">{allergy}</span>
                                                </div>
                                                {editMode && (
                                                    <button
                                        ...
                                        {formData.allergies.length === 0 && (
                                            <div className="col-span-2">
                                                <p className="text-gray-500 italic text-sm">No allergies listed</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-4">
                                        <h3 className="text-lg font-semibold text-white">Protein Preferences</h3>
                                        {editMode && (
                                            <div className="flex gap-2">
                                                <input
                                                    type="text"
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {formData.proteinPreference.map((protein, index) => (
                                            <div key={index} 
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-3 text-gray-300 text-sm">{protein}</span>
                                                </div>
                                                {editMode && (
                                                    <button
                                        ...
                                        {formData.proteinPreference.length === 0 && (
                                            <div className="col-span-2">
                                                <p className="text-gray-500 italic text-sm">No protein preferences listed</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
