                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mt-6 max-w-md mx-auto text-lg md:mt-8 md:max-w-3xl text-gray-400">
                            Get personalized health recommendations, track your progress, and achieve your wellness goals with CoreHealth AI.
                        </p>
                    ...
                    <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative bg-[#13111C] rounded-2xl p-8 h-full border border-purple-900/20 hover:border-purple-500/20 transition-all duration-300">
                                ...
                                <h3 className="text-lg font-semibold text-white">AI-Powered Plans</h3>
                                <p className="mt-2 text-gray-400 leading-relaxed">Personalized workout and diet plans tailored to your goals.</p>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative bg-[#13111C] rounded-2xl p-8 h-full border border-purple-900/20 hover:border-purple-500/20 transition-all duration-300">
                                ...
                                <p className="mt-2 text-gray-400 leading-relaxed">Track your fitness journey with detailed analytics and insights.</p>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative bg-[#13111C] rounded-2xl p-8 h-full border border-purple-900/20 hover:border-purple-500/20 transition-all duration-300">
                                ...
                                <p className="mt-2 text-gray-400 leading-relaxed">Get instant feedback and adjustments to optimize your routine.</p>
                            </div>
                        </div>
                    </div>
                </div>
